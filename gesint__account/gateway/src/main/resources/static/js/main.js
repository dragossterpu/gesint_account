...
function initSettingsPage() {
    switch (user.checkedCurr) {
        case "RON": $("#ronlesign").css({"background-position": "-150px 0"});
            break;
        case "EUR": $("#ronlesign").css({"background-position": "-386px 0"});
            break;
        case "USD": $("#ronlesign").css({"background-position": "-354px 0"});
            break;
    }
...
// SAVINGS: Moving ron sign according to input value length
$("#savingsvalue").bind("keyup keydown keypress select click", function() {savings.freeMoney = $("#savingsvalue").autoNumeric("get"); moveRon();}).keyup(function(e) { if (e.which == 13) {	this.blur() } });
function moveRon() {
    ...
    if (length > 9) {
        ...
        $("#ronlesign").css({"left": (length*15 + 17) + "px", "top": "115px"});
    }
    else if (length > 7 ) {
        $("#savingsvalue").css({"font-size": "38px"});
        $("#ronlesign").css({"left": (length*18 + 18) + "px", "top": "120px"});
    }
    else {
        $("#savingsvalue").css({"font-size": "44px"});
        $("#ronlesign").css({"left": (length*22 + 20) + "px", "top": "125px"});
    }
}

//SAVINGS: change currency on sign click
$("#ronlesign").on("click", function() {
    switch (user.checkedCurr) {
        case "RON": user.checkedCurr = "EUR"; $("#ronlesign").css({"background-position": "-386px 0"});
            break;
        case "EUR": user.checkedCurr = "USD"; $("#ronlesign").css({"background-position": "-354px 0"});
            break;
        case "USD": user.checkedCurr = "RON"; $("#ronlesign").css({"background-position": "-150px 0"});
            break;
    }
    changeCurrency();
